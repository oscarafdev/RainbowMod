...
public class IniParser
{
    ...
    private string name;
    private readonly System.Collections.Generic.List<SectionPair> tmpList = new System.Collections.Generic.List<SectionPair>();
    private Thread _t;
    ...
    public void SaveSettings(string newFilePath)
    {
        ...
        foreach (string str3 in list)
        {
            ...
            foreach (SectionPair pair2 in this.tmpList)
            {
                ...
                {
                    string str = (string)this.keyPairs[pair2];
                    if (str != null) {
                        if (str == "%comment%") {
                            str = "";
                        } else {
